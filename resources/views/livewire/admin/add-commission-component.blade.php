                             ...
                             <table class="table table-hover">
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         <td>{{$i++}}</td>
                                         <td>{{$commission->id}}</td>
                                         <td>{{$commission->commission}} <b>%</b></td>
                                         ...
                                         <td>
                                             <div class="d-flex">
                                                 ...
                                                 <a href="#" wire:click.prevent="updateCommission('{{$commission->id}}','inactive')" class="btn bg-danger mr-4">
                                                     Turn Off Commission
                                                 </a>
                                                 @else
                                                 <a href="#" wire:click.prevent="updateCommission('{{$commission->id}}','active')" class="btn bg-success mr-4">
                                                     Turn On Commission
                                                 </a>
                                                 @endif
                                                 <a href="#" wire:click.prevent="deleteCommission('{{$commission->id}}')" class="btn bg-danger"> <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
